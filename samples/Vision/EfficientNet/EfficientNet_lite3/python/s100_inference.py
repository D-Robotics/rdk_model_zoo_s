...
class EfficientNetLite3:
    """
    @brief Wrapper class for running inference using an EfficientNet-Lite3 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the EfficientNet-Lite3 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using EfficientNet-Lite3.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/efficientnet_lite3_300x300_nv12.hbm',
    ...
    # Initialize EfficientNet-Lite3 model instance
    efficientnet = EfficientNetLite3(opt)
