...
class EfficientNetLite2:
    """
    @brief Wrapper class for running inference using an EfficientNet-Lite2 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the EfficientNet-Lite2 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using EfficientNet-Lite2.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/efficientnet_lite2_260x260_nv12.hbm',
    ...
    parser.add_argument('--test-img', type=str,
                        default='data/Scottish_deerhound.JPEG',
    ...
    # Initialize EfficientNet-Lite2 model instance
    efficientnet = EfficientNetLite2(opt)
