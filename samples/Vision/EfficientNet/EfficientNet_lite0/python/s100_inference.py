...
class EfficientNetLite0:
    """
    @brief Wrapper class for running inference using an EfficientNet-Lite0 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the EfficientNet-Lite0 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using EfficientNet-Lite0.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/efficientnet_lite0_224x224_nv12.hbm',
    ...
    # Initialize EfficientNet-Lite0 model instance
    efficientnet = EfficientNetLite0(opt)
