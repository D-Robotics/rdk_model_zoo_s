...
class EfficientNetLite1:
    """
    @brief Wrapper class for running inference using an EfficientNet-Lite1 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the EfficientNet-Lite1 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using EfficientNet-Lite1.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/efficientnet_lite1_240x240_nv12.hbm',
    ...
    # Initialize EfficientNet-Lite1 model instance
    efficientnet = EfficientNetLite1(opt)
