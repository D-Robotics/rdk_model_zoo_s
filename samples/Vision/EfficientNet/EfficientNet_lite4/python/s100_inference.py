...
class EfficientNetLite4:
    """
    @brief Wrapper class for running inference using an EfficientNet-Lite4 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the EfficientNet-Lite4 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using EfficientNet-Lite4.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/efficientnet_lite4_380x380_nv12.hbm',
    ...
    # Initialize EfficientNet-Lite4 model instance
    efficientnet = EfficientNetLite4(opt)
