...
| YOLOv5mu | 640×640 | 80 | 3.6 ms / 275.7 FPS (1 thread  ) <br/> 5.7 ms / 346.6 FPS (2 threads)   |         |  25.1 M  |  64.2  B |  
| YOLOv5lu | 640×640 | 80 | 6.5 ms / 151.2 FPS (1 thread  ) <br/> 11.6 ms / 170.3 FPS (2 threads)  |         |  53.2 M  |  135.0 B |  
| YOLOv5xu | 640×640 | 80 | 11.6 ms / 85.9 FPS (1 thread  ) <br/> 21.5 ms / 92.4 FPS (2 threads)   |         |  97.2 M  |  246.4 B |  
| YOLOv8n  | 640×640 | 80 | 1.6 ms / 612.8 FPS (1 thread  ) <br/> 1.8 ms / 1047.2 FPS (2 threads)  |         |  3.2  M  |  8.7   B |  
| YOLOv8s  | 640×640 | 80 | 2.3 ms / 414.6 FPS (1 thread  ) <br/> 3.2 ms / 599.2 FPS (2 threads)   |         |  11.2 M  |  28.6  B |  
| YOLOv8m  | 640×640 | 80 | 4.1 ms / 238.6 FPS (1 thread  ) <br/> 6.8 ms / 291.0 FPS (2 threads)   |         |  25.9 M  |  78.9  B |  
| YOLOv8l  | 640×640 | 80 | 7.8 ms / 127.9 FPS (1 thread  ) <br/> 14.0 ms / 141.4 FPS (2 threads)  |         |  43.7 M  |  165.2 B |  
| YOLOv8x  | 640×640 | 80 | 11.7 ms / 85.0 FPS (1 thread  ) <br/> 21.7 ms / 91.5 FPS (2 threads)   |         |  68.2 M  |  257.8 B |  
| YOLO11n  | 640×640 | 80 | 1.6 ms / 585.4 FPS (1 thread  ) <br/> 1.9 ms  / 1028.4 FPS (2 threads) |         |  2.6  M  |  6.5   B |  
| YOLO11s  | 640×640 | 80 | 2.3 ms / 417.0 FPS (1 thread  ) <br/> 3.2 ms  / 603.2 FPS (2 threads)  |         |  9.4  M  |  21.5  B |  
| YOLO11m  | 640×640 | 80 | 4.4 ms / 221.6 FPS (1 thread  ) <br/> 7.4 ms  / 266.0 FPS (2 threads)  |         |  20.1 M  |  68.0  B |  
| YOLO11l  | 640×640 | 80 | 5.5 ms / 178.4 FPS (1 thread  ) <br/> 9.6 ms  / 206.1 FPS (2 threads)  |         |  25.3 M  |  86.9  B |  
| YOLO11x  | 640×640 | 80 | 9.8 ms / 100.9 FPS (1 thread  ) <br/> 18.1 ms / 109.6 FPS (2 threads)  |         |  56.9 M  |  194.9 B |  
| YOLO12n  | 640×640 | 80 | 2.5 ms / 395.4 FPS (1 thread  ) <br/> 3.5 ms / 554.0 FPS (2 threads)   |         |  2.6  M  |  6.5   B |  
| YOLO12s  | 640×640 | 80 | 4.0 ms / 247.8 FPS (1 thread  ) <br/> 6.5 ms / 304.6 FPS (2 threads)   |         |  9.3  M  |  21.4  B |  
| YOLO12m  | 640×640 | 80 | 7.1 ms / 139.5 FPS (1 thread  ) <br/> 12.7 ms / 155.8 FPS (2 threads)  |         |  20.2 M  |  67.5  B |  
...
### PTQ方案量化转化
 ...
 - 参考天工开物工具链手册和OE包，对模型进行检查.


在对于的yaml配置中修改需要移除反量化节点的名称:
...
model_parameters:
  ...
  remove_node_name: "492;514;536;"  # Depend on your onnx model.
```
...
如果模型的输出情况与Model Zoo不一致, 原因可能是移除的节点名称错误, 可通过查看bc模型的信息来确认.
```bash
# 快速产生一个bc模型
hb_compile --fast-perf --march nash-e --skip compile --model yolo11n.onnx
# 查看bc模型的输出节点信息
hb_model_info model_output/yolo11n_quantized_model.bc
```
