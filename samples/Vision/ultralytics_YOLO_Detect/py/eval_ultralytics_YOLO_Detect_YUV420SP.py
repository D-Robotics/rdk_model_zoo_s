...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='source/reference_hbm_models/yolov8_hbm/yolov8x_detect_nashe_640x640_nv12.hbm', 
    ...
    parser.add_argument('--json-path', type=str, default="yolov8x_detect_nashe_640x640_nv12_coco2017_val_pridect.json", help='convert to json save path.')
