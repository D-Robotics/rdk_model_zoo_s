...
模型转换使用的是Onnx model: https://pytorch.org/vision/main/models/generated/torchvision.models.resnet18.html

若需要 resnet18 模型量化转换步骤，可以参考 ResNet 其他模型的转换步骤或是直接使用 OE 开发包中的 samples/ai_toolchain/horizon_model_convert_sample/03_classification/13_resnet18
