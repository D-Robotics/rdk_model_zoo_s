...
class ResNet152:
    """
    @brief Wrapper class for running inference using a ResNet152 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the ResNet152 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using ResNet152.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/resnet152_224x224_nv12.hbm',
    ...
    # Initialize ResNet152 model instance
    resnet152 = ResNet152(opt)
