...
After downloading the .hbm file, you can run the `test_resnet50.ipynb` Jupyter notebook on the board to test the model. To change the test image, download your dataset, place it in the `data` folder, and update the image path in the notebook.
