...
class ResNet50:
    """
    @brief Wrapper class for running inference using a ResNet50 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the ResNet50 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using ResNet50.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/resnet50_224x224_nv12.hbm',
    ...
    # Initialize ResNet50 model instance
    resnet50 = ResNet50(opt)
