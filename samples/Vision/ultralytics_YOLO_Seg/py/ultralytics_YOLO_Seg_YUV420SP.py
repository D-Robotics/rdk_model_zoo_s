...
def main():
    ...
    if not os.path.exists(opt.model_path):
        ...
        os.system("wget -c https://archive.d-robotics.cc/downloads/rdk_model_zoo/rdk_s100/ultralytics_YOLO/yolo11n_seg_nashe_640x640_nv12.hbm")
        opt.model_path = 'yolo11n_seg_nashe_640x640_nv12.hbm'
