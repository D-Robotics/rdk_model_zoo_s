...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='source/reference_hbm_models/yolo13x_detect_nashe_640x640_nv12.hbm', 
    ...
    if not os.path.exists(opt.model_path):
        ...
        os.system("wget -c https://archive.d-robotics.cc/downloads/rdk_model_zoo/rdk_s100/iMoonLab_YOLOv13/yolo13n_detect_nashe_640x640_nv12.hbm")
        opt.model_path = 'yolo13n_detect_nashe_640x640_nv12.hbm'
...
class YOLO11_Detect():
    def __init__(self, opt):
        ...
        self.quantize_model.output_names
        ...
        self.m_bboxes_scale = self.quantize_model.output_quants[self.quantize_model.model_names[0]][self.quantize_model.output_names[self.quantize_model.model_names[0]][3]].scale[np.newaxis, :]
        self.l_bboxes_scale = self.quantize_model.output_quants[self.quantize_model.model_names[0]][self.quantize_model.output_names[self.quantize_model.model_names[0]][5]].scale[np.newaxis, :]
