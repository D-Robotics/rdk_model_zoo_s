...
class MobileNetV4:
    """
    @brief Wrapper class for running inference using a MobileNetV4 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the MobileNetV4 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using MobileNetV4.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/mobilenetv4_small_224x224_nv12.hbm',
    ...
    # Initialize MobileNetV4 model instance
    mobilenetv4 = MobileNetV4(opt)
