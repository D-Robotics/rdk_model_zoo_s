...
class MobileNetV3:
    """
    @brief Wrapper class for running inference using a MobileNetV3 model through HB_HBMRuntime.
    """

    def __init__(self, opt):
        """
        @brief Initialize the MobileNetV3 model with model path and extract I/O details.
...
def main() -> None:
    """
    @brief Main function to perform image classification using MobileNetV3.
    ...
    parser.add_argument('--model-path', type=str,
                        default='./model/mobilenetv3_224x224_nv12.hbm',
    ...
    # Initialize MobileNetV3 model instance
    mobilenetv3 = MobileNetV3(opt)
